...
| NOTIF-01-BE | Push + SMS Notifications | DONE | Push/SMS adapter and notification logs wired in; `POST /api/auth/push-subscribe` added; enrollment, payment, and assessment events now dispatch notifications; `pnpm notify:fee-due` script added for monthly reminders; BE lint/typecheck passed |
